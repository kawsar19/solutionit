          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="left__content">
                ...
                <h3 className="footer__email">info@email.com</h3>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="right__content">
                <div className="footer__social">
                  <ul className="scciallist">
                    <li className="scciallist__item">
                      <a href="" className="scciallist__link">
                        Facebook
                      </a>
                    </li>
                    <li className="scciallist__item">
                      <a href="" className="sociallist__link">
                        Linkedin
                      </a>
                    </li>
                    <li className="scciallist__item">
...
<path d="M0.704883 2.99347L8.08077 7.91091C8.35998 8.09707 8.67997 8.19012 8.99996 8.19012C9.31999 8.19012 9.64002 8.09703 9.91923 7.91091L17.2951 2.99347C17.7365 2.69939 18 2.2072 18 1.67599C18 0.762594 17.2569 0.0195312 16.3435 0.0195312H1.65646C0.743098 0.0195664 0 0.762629 0 1.67687C0 2.2072 0.263531 2.69939 0.704883 2.99347Z" fill="white"/>
          ...
          <div className="footer__links">
            <ul className="footerlink">
                <li className="footerlink__item"><a href="" className="footerlink__link">HOME</a></li>
                <li className="footerlink__item"><a href="" className="footerlink__link">ABOUT</a></li>
                <li className="footerlink__item"><a href="" className="footerlink__link">SERVICES</a></li>
                <li className="footerlink__item"><a href="" className="footerlink__link">PORTFOLIO</a></li>
                <li className="footerlink__item"><a href="" className="footerlink__link">BLOG</a></li>
                <li className="footerlink__item"><a href="" className="footerlink__link">CONTACT US</a></li>
            </ul>
          </div>
        </div>
